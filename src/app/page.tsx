...
export default function Home() {
  return (
    <div className="bg-gray-100">
      <nav className="px-8 h-24 flex justify-between gap-4 items-center font-semibold">
        <a href="/">
          <svg
        ...
        <ul className="flex items-center gap-8">
          <li className="group">
            ...
            <ul className="invisible group-hover:visible hover:visible absolute flex gap-3 flex-col mt-1 p-8 bg-white rounded-xl text-base text-gray-500">
              <li>
        ...
        <ul className="flex gap-4 justify-evenly items-center">
          <li>
            <form action="" className="relative">
              <svg
                ...
                fill="none"
                aria-hidden="true"
                className="absolute text-gray-400 top-2 left-2 mr-3 flex-none"
              >
                <path
                  d="m19 19-3.5-3.5"
                  stroke="currentColor"
              ...
              <input
                className="ps-9 py-2 rounded-xl w-40 font-normal"
                type="text"
                name="search"
                id="search"
                placeholder="Search"
          ...
          <li>
            <a className="bg-black text-white px-5 py-3 rounded-full" href="/">
              Sign up
            </a>
          </li>
        </ul>
      </nav>
      <section className="text-center pt-20 px-60">
        <a
          href="/"
        ...
        <h1 className="text-7xl py-12 font-serif">
      ...
      <section>
        <h2 className="text-center text-5xl pb-12">Explore inspiring designs</h2>
      </section>
    </div>
