...
export default function Navbar() {
  ...
  return (
    <nav className="px-4 md:px-8 h-24 flex justify-between items-center font-semibold">
      <a href="/">
        <svg
      ...
      <div className={`flex-col md:flex-row md:flex md:gap-8 ${isOpen ? 'flex z-10 absolute top-5 right-0' : 'hidden'} md:items-center`}>
        <ul className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
          ...
          <li className="group">
            ...
            <ul className="hidden md:visible group-hover:flex absolute flex-col mt-1 p-4 bg-white rounded-xl text-base text-gray-500">
              <li>
                <a className="flex flex-col font-semibold" href="/">
                  Designers Search
                  <span className="text-sm font-normal text-gray-400">
        ...
        <ul className="flex flex-col md:flex-row gap-4 md:gap-8 items-center">
          <li>
            <form action="" className="relative">
              ...
              <input
                className="pl-10 py-2 rounded-xl w-full md:w-40 font-normal"
                type="text"
                name="search"
                id="search"
                placeholder="Search"
